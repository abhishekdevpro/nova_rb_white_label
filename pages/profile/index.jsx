    ...
    const fetchData = async () => {
      try { 
        ...
        if (userProfileResponse.data.status === 'success') {
          ...
          // Fetch countries
          const countriesResponse = await axios.get('https://api.novajobs.us/api/user/countries');
  ...
  useEffect(() => {
    const fetchStates = async () => {
      if (formData.country_id) {
        try {
          const token = localStorage.getItem("token");
          const response = await axios.get(`https://api.novajobs.us/api/user/stats/${formData.country_id}`, {
            headers: {
  ...
  useEffect(() => {
    const fetchCities = async () => {
      if (formData.state_id) {
        ...
        try {
          const citiesResponse = await axios.get(`https://api.novajobs.us/api/user/cities/${formData.state_id}`);
