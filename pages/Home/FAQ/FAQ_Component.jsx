...
const FAQ = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api.novajobs.us/api/user/contact-us', {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    <div className='lg:flex justify-center flex-row gap-10 pb-20 bg-white'>
      ...
      <div className="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-96 p-6">
        ...
        <div className=''>
          <button className='border px-3 p-2 rounded-lg'>
          <a href="mailto:info@Novajobs.US" className="text-slate-900  font-semibold text-sm hover:underline flex items-center">
          info@Novajobs.US
            <svg xmlns="http://www.w3.org/2000/svg" className="ml-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
            </svg>
