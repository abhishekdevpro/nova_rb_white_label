...
function Payment() {
    ...
    const handleChoosePlan3 = () => {
      ...
      axios.post('https://apiwl.novajobs.us/api/user/paypal/create-payment', payload, {
            ...
            <tr>
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                <div className="text-center mt-4">
                  <p className="text-lg font-bold text-slate-900 m">Free</p>
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600  tracking-wider">
                <div className="text-center">
                  ...
                  <span className=" text-slate-900 font-bold text-lg"> $49</span> <span className=" text-slate-900 ">/One Time Purchase</span><br/>
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600  tracking-wider">
                <div className="text-center">
                  ...
                  <span className=" text-slate-900 font-bold text-lg"> $269</span> <span className=" text-slate-900 ">/Resume </span><br/>
                  <button
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600  tracking-wider">
                <div className="text-center">
                  ...
                  <span className=" text-slate-900 font-bold text-lg"> $369</span> <span className=" text-slate-900 ">/Resume </span><br/>
                  <button
