...
function AiJobMatchApply() {
  return (
    <div className="m-10 mx-40 p-5  shadow-2xl">
      ...
      At Novajobs.US, we aim to make your job search efficient and effective
      ...
      Sign up on the Novajobs.US platform and create your profile. Upload
      ...
      Transform your job search with Novajobs.US’s AI Job Match & Apply tool.
