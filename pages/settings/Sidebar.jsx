...
const Sidebar = () => {
  ...
  const getLinkClassName = (path) => {
    return router.pathname === path
      ...
      : "flex items-center p-2 hover:bg-blue-600 hover:text-white border-b-2 rounded font-semibold";
  };
        ...
        <ul className="space-y-2 mt-4">
          <li>
            <Link
              ...
              className="flex items-center p-2 bg-blue-600 border-b-2 border-black font-semibold text-white rounded-xl"
              onClick={toggleSidebar}
            >
