...
const Templatelistpage = () => {
  const boxes = [
    <Link href="" key="box1">
      <div className="bg-slate-900 shadow-indigo-900 shadow-xl rounded-lg text-center text-white cursor-pointer text-3xl font-semibold box-hover-effect">
        <Image src={template1} style={{height:"300px", width:"240px"}} alt="logo"/>
      </div>
    </Link>,
    <Link href="" key="box2">
      <div className="bg-slate-900 rounded-lg shadow-xl shadow-indigo-900 text-center text-white cursor-pointer text-3xl font-semibold box-hover-effect">
