...
function Addreferall() {
    const boxes = [
        <Link href="#" key="box1">
          <div className="bg-slate-900 hover:bg-gray-300 hover:text-black rounded-lg shadow-md pt-16 w-80 h-60 text-center text-white cursor-pointer text-3xl font-semibold">
