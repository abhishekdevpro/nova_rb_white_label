          ...
          <div className=" bg-gray-50 flex flex-col">
            <div className="flex flex-col md:flex-row flex-grow ">
              <button
                ...
                className="fixed z-10 bottom-20 right-4  bg-blue-500 text-white p-3 rounded-full shadow-lg"
              >
                {isMobileSidebarOpen ? (
            ...
            <div className="">
              <div className="flex items-center absolute justify-center gap-2 p-2  top-26 left-0 right-0 bg-white shadow-lg ">
                ...
                {/* <select
                  ...
                  className="rounded-lg border-2 border-blue-500 px-5 py-2 font-bold  bg-white text-black"
                >
              ...
              <div className="flex items-center justify-center gap-4 p-2 fixed bottom-0 left-0 right-0 bg-white shadow-lg ">
                ...
                <button
                  ...
                  className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors bottom-btns"
                >
