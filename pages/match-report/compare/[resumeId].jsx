...
const ResumeComparison = () => {
  ...
  const getSectionData = (sectionKey, analysisData) => {
    ...
    let searchabilityAnalysis, recruiterTipsAnalysis, skillsAnalysis,formattingAnalysis;
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between flex-col md:flex-row gap-4 ">
            ...
            <div className="flex-1 flex flex-col md:flex-row md:justify-center md:items-center gap-2">
              <Button
