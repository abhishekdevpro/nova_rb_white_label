...
//     // Check if valid
//     const valid = count >= MIN_WORDS && count <= MAX_WORDS;
//     setIsValid(valid);
...
//           }`}
//           placeholder="Paste your Job Description here... (Minimum 50 words, Maximum 500 words)"
//           rows={8}
//           value={formData.job_description || ""}
//           onChange={handleTextChange}
//         />

//         {/* Word count and validation info */}
//         <div className="flex justify-between items-center mt-2">
//           <div className="text-sm text-gray-600">
//             <span
//               className={
//                 wordCount < MIN_WORDS ? "text-red-500" : "text-green-600"
//               }
//             >
//               {wordCount}
//             </span>
...
//           <div className="text-xs text-gray-500">Min: {MIN_WORDS} words</div>
//         </div>
