...
const Skill = ({ title, currentSkillIndex }) => {
  ...
  // if (resumeData.skills.length === 0 || !resumeData.skills) {
  //   return <div>No skills available</div>;
  //   }
console.log(resumeData.skills,skillType,"skills");
  return (
    <div className="flex-col-gap-3 w-full md:mt-10 md:px-10">
      ...
      (skillType?.skills.map((skill, index) => (
        <div key={index} className="relative flex items-center space-x-2">
          ...
          {activeTooltip === `skill-${index}` && (
            <div className="absolute z-10 right-10 top-10 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200">
              <div className=" px-4 py-2 rounded-t-lg border-b border-red-100">
      ...
      <div className="flex space-x-4 py-4 ">
        ...
        <button
          ...
          className="border bg-black text-white px-3 rounded-lg"
          disabled={loading}
        >
