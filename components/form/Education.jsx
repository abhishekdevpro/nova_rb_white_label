...
//                 <label className="text-black py-1">School/University</label>
//                 <input
//                   type="text"
//                   placeholder="School"
//                   name="school"
...
//             <div className="relative mb-4">
//               <label className="text-black py-1">Degree</label>
//               <input
//                 type="text"
//                 placeholder="Degree"
//                 name="degree"
...
//               {showDegreeDropdown && focusedIndex === index && degreeSuggestions.length > 0 && (
...
//             <div className="relative">
//               <label className="mt-2 text-black py-1">Location</label>
//               <div className="relative">
//                 <input
//                   type="text"
...
const Education = () => {
  ...
  const fetchDegrees = async (keyword, index) => {
    ...
    try {
      const response = await fetch(
        `https://apiwl.novajobs.us/api/user/degree?degree_keyword=${encodeURIComponent(keyword)}`,
      )
      if (response.ok) {
        const data = await response.json()
        setDegreeSuggestions(data.data?.map((item) => item.name) || [])
