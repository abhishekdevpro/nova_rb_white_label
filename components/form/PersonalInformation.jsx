...
// console.log(resumeStrength?.personal_info_strenght?.contactInformation,"contactInformation");
  return (
            ...
            ({ field, placeholder, type, hasSuggestions, hasCountryCode }) => (
              ...
              >
                ...
                {activeTooltip === field && hasErrors(field) && (
                  <div className="absolute z-50 right-4 mt-2 w-80 bg-white rounded-lg shadow-xl transform transition-all duration-200 ease-in-out border border-gray-700">
