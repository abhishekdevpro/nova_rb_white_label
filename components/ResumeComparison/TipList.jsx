...
export default function TipsList({ title, tips = [], tipsStatus = [] }) {
  return (
    <div className="flex flex-col md:flex-row items-start border-t first:border-t-0">
      {/* Left Title */}
      <div className="w-full md:w-1/3 px-4 py-3 font-semibold text-gray-800">{title}</div>
