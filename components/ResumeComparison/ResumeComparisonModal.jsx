        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-xl p-5 flex flex-col items-center shadow-md bg-gray-50 w-full">
              ...
              <div className="relative w-full max-h-[60vh] overflow-y-auto rounded-lg flex items-center justify-center bg-gray-100">
                {beforeLoading && (
                ...
                <img
                  ...
                  onError={() => setBeforeLoading(false)}
                />
              </div>
