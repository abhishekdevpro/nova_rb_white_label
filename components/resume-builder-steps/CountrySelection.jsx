    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-200 flex flex-col">
      <main className="flex-1 flex flex-col items-center px-4 py-10">
        <div className="max-w-3xl text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-blue-700 hover:text-blue-800 leading-snug mb-2">
            For which country to tailor your resume to its specific
            requirements.
          </h1>
          <p className="text-md md:text-lg text-blue-700 hover:text-blue-800 ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <button
                ...
                className="p-5 rounded-2xl shadow-md border border-gray-200 bg-blue-200 hover:bg-blue-700 hover:text-white hover:shadow-xl flex flex-col items-center transition-all duration-200 group"
              >
                <Image
                  src={country.flag}
                  alt={country.name}
                ...
                />
                <span className="text-blue-700 group-hover:text-white font-semibold text-lg mb-2 transition-colors duration-200">
                  {country.name}
                </span>
