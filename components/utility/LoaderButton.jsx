...
//     <button
//       onClick={onClick}
//       className={`relative flex items-center justify-center px-4 py-2 font-medium text-white bg-blue-400 rounded-md hover:bg-blue-500 disabled:bg-blue-300 ${className}`}
//       disabled={isLoading}
//       {...props}
//     >
//       {isLoading ? (
...
const LoaderButton = ({ isLoading, onClick, children, className = '', ...props }) => {
  return (
    <button
      onClick={onClick}
      className={`relative flex items-center justify-center px-4 py-2 font-medium text-white bg-blue-400 rounded-lg hover:bg-blue-500 disabled:bg-blue-300 ${className}`}
      disabled={isLoading}
      {...props}
    >
